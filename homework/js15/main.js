...
document.addEventListener("keydown", (e) => {
  if (e.code == "KeyW" && snake.y !== config.sizeCell) {
    snake.dy = -config.sizeCell;
    snake.dx = 0;
  } else if (e.code == "KeyA" && snake.y !== config.sizeCell) {
    snake.dx = -config.sizeCell;
    snake.dy = 0;
  } else if (e.code == "KeyS" && snake.x !== config.sizeCell) {
    snake.dy = config.sizeCell;
    snake.dx = 0;
  } else if (e.code == "KeyD" && snake.x !== config.sizeCell) {
    snake.dx = config.sizeCell;
    snake.dy = 0;
  }
});
